    ...
    , mPlotEnabled15(false)
{
    ...
    QPushButton *cbutton1 = new QPushButton("...");
    ...
    QPushButton *cbutton2 = new QPushButton("...");
    ...
    //connect(cbutton2, SIGNAL(clicked(bool)), this, SLOT(cColorSet1(bool)));
    ...
    QPushButton *cbutton3 = new QPushButton("...");
    ...
    QPushButton *cbutton4 = new QPushButton("...");
    ...
    QPushButton *cbutton5 = new QPushButton("...");
    ...
    QPushButton *cbutton6 = new QPushButton("...");
    ...
    //connect(cbutton6, SIGNAL(clicked(bool)), this, SLOT(cColorSet1(bool)));
    ...
    QPushButton *cbutton7 = new QPushButton("...");
    ...
    QPushButton *cbutton8 = new QPushButton("...");
    ...
    QPushButton *cbutton9 = new QPushButton("...");
    ...
    QPushButton *cbutton10 = new QPushButton("...");
    ...
    QPushButton *cbutton11 = new QPushButton("...");
    ...
    QPushButton *cbutton12 = new QPushButton("...");
    ...
    QPushButton *cbutton13 = new QPushButton("...");
    ...
    QPushButton *cbutton14 = new QPushButton("...");
    ...
    QPushButton *cbutton15 = new QPushButton("...");
